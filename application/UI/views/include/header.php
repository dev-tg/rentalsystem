<html>
    <head>
        ...
        <meta name="apple-mobile-web-app-title" content="NRPC">
        ...
        <!-- build:css <?php echo base_url(); ?>assets/styles/app.min.css -->
    ...
    <body>
        <div class="app" id="app" ng-app="nrpcOcc">