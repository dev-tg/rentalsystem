...
class Automobile_Controller extends MY_Controller {

    function __construct() {
        parent::__construct();

        $this->load->model("Automobile_Model", "modelObj");
    }

    public function getVehiclePostData() {
        $pagination = json_decode($this->input->raw_input_stream, true);

        $result = $this->modelObj->getVehiclePostData($pagination);
